...
class NoSlowDown
    ...
    void onUpdate ( ) {
        ...
        if ( this.webs.getValue ( ) && Phobos.moduleManager.getModuleByClass ( Flight.class ).isDisabled ( ) && Phobos.moduleManager.getModuleByClass ( BlockPhase.class ).isDisabled ( ) && NoSlowDown.mc.player.isInWeb ) {
