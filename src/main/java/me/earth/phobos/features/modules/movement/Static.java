...
class Static
        extends Module {
    private final Setting < Mode > mode = this.register ( new Setting <> ( "Mode" , Mode.ROOF ) );
    ...
    void onUpdate ( ) {
        ...
        switch (this.mode.getValue ( )) {
            ...
            case NOVOID: {
                ...
                if ( Phobos.moduleManager.isModuleEnabled ( BlockPhase.class ) || Phobos.moduleManager.isModuleEnabled ( Flight.class ) ) {
                    return;
                }
